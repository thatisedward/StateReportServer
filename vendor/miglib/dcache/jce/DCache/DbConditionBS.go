...
func (st *DbConditionBS) resetDefault() {
}

func (st *DbConditionBS) ReadFrom(_is *codec.Reader) error {
	var err error
	var length int32
	var have bool
	var ty byte
...
func (st *DbConditionBS) ReadBlock(_is *codec.Reader, tag byte, require bool) error {
	var err error
	var have bool
	st.resetDefault()
	...
	if !have {
		if require {
			return fmt.Errorf("require DbConditionBS, but not exist. tag %d", tag)
		} else {
			return nil
		}
	}
...
func (st *DbConditionBS) WriteTo(_os *codec.Buffer) error {
	var err error
...
func (st *DbConditionBS) WriteBlock(_os *codec.Buffer, tag byte) error {
	var err error
