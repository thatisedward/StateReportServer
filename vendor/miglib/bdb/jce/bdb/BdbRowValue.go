...
type BdbRowValue struct {
	MField   map[string]BdbField
	IVersion int64
}

func (_obj *BdbRowValue) resetDefault() {
	_obj.IVersion = 0
}

func (_obj *BdbRowValue) WriteTo(_os serializer.JceOutputStream) error {
	var _err error
...
func (_obj *BdbRowValue) ReadFrom(_is serializer.JceInputStream) error {
	var _err error
	var _i interface{}
	_obj.resetDefault()
...
func (_obj *BdbRowValue) Display(_ds serializer.JceDisplayer) {
	_ds.Display(reflect.ValueOf(&_obj.MField), "mField")
	_ds.Display(reflect.ValueOf(&_obj.IVersion), "iVersion")
}

func (_obj *BdbRowValue) WriteJson(_en serializer.JceJsonEncoder) ([]byte, error) {
	var _err error
...
func (_obj *BdbRowValue) ReadJson(_de serializer.JceJsonDecoder) error {
