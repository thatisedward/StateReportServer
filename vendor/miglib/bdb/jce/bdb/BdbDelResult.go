...
type BdbDelResult struct {
	STableName        string
	MpFailIndexReason map[int32]int32
}

func (_obj *BdbDelResult) resetDefault() {
	_obj.STableName = ""
}

func (_obj *BdbDelResult) WriteTo(_os serializer.JceOutputStream) error {
	var _err error
...
func (_obj *BdbDelResult) ReadFrom(_is serializer.JceInputStream) error {
	var _err error
	var _i interface{}
	_obj.resetDefault()
...
func (_obj *BdbDelResult) Display(_ds serializer.JceDisplayer) {
...
func (_obj *BdbDelResult) WriteJson(_en serializer.JceJsonEncoder) ([]byte, error) {
	var _err error
...
func (_obj *BdbDelResult) ReadJson(_de serializer.JceJsonDecoder) error {
