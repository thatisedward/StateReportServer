...
type BdbUpdateResult struct {
	STableName        string
	MpFailIndexReason map[int32]int32
}

func (_obj *BdbUpdateResult) resetDefault() {
	_obj.STableName = ""
}

func (_obj *BdbUpdateResult) WriteTo(_os serializer.JceOutputStream) error {
	var _err error
...
func (_obj *BdbUpdateResult) ReadFrom(_is serializer.JceInputStream) error {
	var _err error
	var _i interface{}
	_obj.resetDefault()
...
func (_obj *BdbUpdateResult) Display(_ds serializer.JceDisplayer) {
...
func (_obj *BdbUpdateResult) WriteJson(_en serializer.JceJsonEncoder) ([]byte, error) {
	var _err error
...
func (_obj *BdbUpdateResult) ReadJson(_de serializer.JceJsonDecoder) error {
