...
func (_obj *StatOneLog) WriteTo(_os serializer.JceOutputStream) error {
	var _err error
...
func (_obj *StatOneLog) ReadFrom(_is serializer.JceInputStream) error {
	var _err error
	var _i interface{}
	_obj.resetDefault()
...
func (_obj *StatOneLog) Display(_ds serializer.JceDisplayer) {
...
func (_obj *StatOneLog) WriteJson(_en serializer.JceJsonEncoder) ([]byte, error) {
	var _err error
...
func (_obj *StatOneLog) ReadJson(_de serializer.JceJsonDecoder) error {
