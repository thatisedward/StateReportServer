...
func (_obj *StatValue) WriteTo(_os serializer.JceOutputStream) error {
	var _err error
...
func (_obj *StatValue) ReadFrom(_is serializer.JceInputStream) error {
	var _err error
	var _i interface{}
	_obj.resetDefault()
...
func (_obj *StatValue) Display(_ds serializer.JceDisplayer) {
...
func (_obj *StatValue) WriteJson(_en serializer.JceJsonEncoder) ([]byte, error) {
	var _err error
...
func (_obj *StatValue) ReadJson(_de serializer.JceJsonDecoder) error {
