...
func (_obj *StatLog) WriteTo(_os serializer.JceOutputStream) error {
	var _err error
...
func (_obj *StatLog) ReadFrom(_is serializer.JceInputStream) error {
	var _err error
	var _i interface{}
	_obj.resetDefault()
...
func (_obj *StatLog) Display(_ds serializer.JceDisplayer) {
...
func (_obj *StatLog) WriteJson(_en serializer.JceJsonEncoder) ([]byte, error) {
	var _err error
...
func (_obj *StatLog) ReadJson(_de serializer.JceJsonDecoder) error {
